...
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://backend-dashboard-qpid.onrender.com';
const RAYLEIGH_API_URL = import.meta.env.VITE_RAYLEIGH_URL || 'https://backend-rayleigh.onrender.com';
